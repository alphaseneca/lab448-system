...
export function getThermalBillPrintStyles() {
  ...
  return `
    * { box-sizing: border-box; }
    html, body { margin: 0; padding: 0; width: ${w}mm; min-width: ${w}mm; max-width: ${w}mm; min-height: 100%; background: #fff; font-family: 'Montserrat', sans-serif; font-size: 11pt; font-weight: 600; color: #000; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    .thermal-bill .bill-number { font-weight: 800; font-size: 13pt; word-break: break-word; letter-spacing: 0.3px; }
    .thermal-bill .bill-datetime { font-size: 10pt; font-weight: 600; color: #111; margin-top: 1mm; }
    .thermal-bill .line-solid { border: none; border-top: 2px solid #000; margin: 4mm 0; }
    .thermal-bill .line-dashed { border: none; border-top: 1px dashed #000; margin: 4mm 0; }
    .thermal-bill .customer-row { display: flex; justify-content: space-between; align-items: flex-start; gap: 4mm; font-size: 10pt; font-weight: 600; margin: 2.5mm 0; }
    .thermal-bill .customer-label { font-weight: 800; flex-shrink: 0; }
    .thermal-bill .customer-value { text-align: right; flex: 1; min-width: 0; word-break: break-word; overflow-wrap: break-word; }
    .thermal-bill .items-table { width: 100%; border-collapse: collapse; font-size: 9pt; font-weight: 600; margin: 4mm 0 2mm 0; table-layout: fixed; }
    .thermal-bill .items-table th { font-weight: 800; font-size: 9pt; padding: 2.5mm 1.5mm 2.5mm 0; border-bottom: 2px solid #000; }
    ...
    .thermal-bill .items-table th.th-rate { width: 15mm; min-width: 15mm; text-align: right; padding-right: 0; }
    .thermal-bill .items-table th.th-amt { width: 15mm; min-width: 15mm; text-align: right; padding-right: 0; }
    .thermal-bill .items-table td { font-size: 9pt; font-weight: 600; padding: 2.5mm 1.5mm 2.5mm 0; border-bottom: 1px solid #ccc; vertical-align: top; }
    ...
    .thermal-bill .items-table tr.group-header td { font-weight: 800; font-size: 10pt; border-bottom: 1px dashed #000; padding: 3mm 1.5mm 3mm 0; background: #f0f0f0; word-break: break-word; overflow-wrap: break-word; }
    .thermal-bill .summary-row { display: flex; justify-content: space-between; gap: 4mm; font-size: 10pt; font-weight: 600; margin: 2.5mm 0; }
    .thermal-bill .summary-label { font-weight: 800; flex-shrink: 0; }
    .thermal-bill .summary-value { text-align: right; flex-shrink: 0; }
    .thermal-bill .total-row { font-size: 13pt; font-weight: 800; margin-top: 3mm; padding-top: 3mm; border-top: 2px solid #000; letter-spacing: 0.3px; }
    .thermal-bill .bill-footer { text-align: center; margin-top: 6mm; font-size: 10pt; font-weight: 600; color: #111; word-break: break-word; }
    .thermal-bill .bill-footer .thanks { margin-bottom: 2mm; font-weight: 700; }
