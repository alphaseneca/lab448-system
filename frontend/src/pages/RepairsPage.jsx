    ...
    <div className="animate-fade-in flex flex-col gap-6">
      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          <NavLink to={APP_ROUTES.NEW_REPAIR_ORDER} className="btn btn-primary w-full sm:w-auto">
      ...
      <div className="card p-0 overflow-hidden flex flex-col">
        ...
        {/* Toolbar */}
        <div className="p-4 border-b border-panel bg-surface flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3">
          <div className="relative w-full sm:w-72">
            ...
            <input 
              ...
              className="pl-9 py-2 text-sm bg-primary border-panel w-full"
              value={searchTerm}
              ...
              {loading ? (
                <tr>
                  <td colSpan="5" className="py-12 text-center text-muted">
                    <span className="loading-spinner spinner-lg text-accent-primary mb-2"></span>
                    <p>Loading queue data...</p>
                  </td>
                </tr>
              ) : filtered.length === 0 ? (
                <tr>
                  <td colSpan="5" className="py-16 text-center text-muted bg-secondary/20">
                ...
                <tr key={repair.id} className="border-b border-panel hover:bg-surface-hover transition-colors group cursor-pointer" onClick={() => navigate(APP_ROUTES.REPAIR_ORDER_DETAILS(repair.id))}>
                  ...
                  <td className="py-4 px-6">
                    <div className="font-semibold text-text-primary">{repair.customer?.name || 'Unknown'}</div>
        ...
        <div className="p-3 border-t border-panel bg-secondary/10 flex items-center justify-between text-xs text-muted">
