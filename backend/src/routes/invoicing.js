...
router.post("/:invoiceId/pay", checkPermission(PERMISSIONS.MANAGE_BILLING), invoicingController.applyPayment);
...
router.post("/:invoiceId/items", checkPermission(PERMISSIONS.MANAGE_BILLING), invoicingController.addInvoiceItem);
